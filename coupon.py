# -*- coding: utf-8 -*-
"""
Created on Fri Mar 29 17:57:37 2019
...
dfoff = pd.read_csv('F:\chormeDownloads/ccf_offline_stage1_train.csv')
dftest = pd.read_csv('F:\chormeDownloads/ccf_offline_stage1_test_revised.csv')
dfon = pd.read_csv('F:\chormeDownloads/ccf_online_stage1_train.csv')
print('data read end.')
